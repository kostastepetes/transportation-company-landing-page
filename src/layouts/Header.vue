...
<template>
    ...
    <div class="container mx-auto px-5">
        <header class="flex justify-between py-12 items-center">
            <div>
                <a href="/">
                <h1 class="text-2xl xl:text-2xl font-bold font-theme-heading text-center lg:text-left">Mykonos Transport Co.</h1>
                </a>
            </div>
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul class="space-x-10 font-theme-heading font-medium items-center hidden md:flex  flex-col space-y-7 md:space-y-0 md:flex-row">
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#features" v-smooth-scroll>Services</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#faq" v-smooth-scroll>About</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#subscribe" v-smooth-scroll>Book Us</a></li>
                </ul>
            </nav>
        </header>
        ...
        <div v-show="mobileNav">
            <div class="absolute px-5 py-12 block z-30 top-0 left-0 w-full h-full bg-gradient-to-b from-theme-dark-blue via-theme-dark-blue-tp to-theme-dark-blue">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl xl:text-2xl font-bold text-white font-theme-heading text-center">Mykonos Transport Co.</h1>
